...
See `docs/BID_PERIODS.md` for the maintained human-readable table and boundary rules. Runtime definitions live in `TripDataHub/Services/BidPeriodService.swift`.
